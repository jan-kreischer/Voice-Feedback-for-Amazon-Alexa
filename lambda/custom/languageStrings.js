module.exports = {
  translation: {
    ...
    SUBMIT_BUG_REPORT_MESSAGE: 'Thank you very much for reporting the error. This helps to improve the service for you and for everyone.',
    SUBMIT_FEATURE_REQUEST_MESSAGE: 'Thank you very much for telling us your idea. ',
    SUBMIT_QUESTION_MESSAGE: 'Thank you very much!',
    SUBMIT_CRITICISM_MESSAGE: 'Thank you very much!',
    SUBMIT_GENERAL_FEEDBACK: 'Thank you very much!',
    
    FEEDBACK_SUBMIT_MESSAGE: 'Thank you very much! Your feedback got submitted. We will process it as fast as possible and contact you then.',
    NORMAL_FEEDBACK_SUBMIT_MESSAGE: "",
    ANONYMOUS_FEEDBACK_SUBMIT_MESSAGE: "",
    
    SKIP_MESSAGE: "Sorry, you can not skip this step because I really need to this information. You can always ask for help by saying help, or stop by saying stop.",
    ...
    FALLBACK_MESSAGE: "Sorry, I don't understand. Can you please rephrase what you said."
  }
};
